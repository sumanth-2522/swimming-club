                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-sm-7 mx-auto">
                                    <form method="POST" action="{{ route('dashboard.updateRaceData') }}">
                                    @csrf
                                    ...
                                    <!-- Tournament -->
                                        ...
                                        <!-- race id -->
                                        <div class="row">
                                            <x-input id="raceid" class="block mt-1 mb-4 w-full" type="hidden" name="raceid"
                                                     value="{{$raceData->id}}" required autofocus/>
                                        </div>
